...
function SApplication() {
  return (
    <main>
        <Helmet>
            <title>نهال آی تی | خدمات اپلیکیشن موبایل</title>
        </Helmet>
      <header>
      ...
      <div className='MobileApplication-content Services-style flex flex-col items-center gap-10 mb-10'>
        <img src={"/img/MobileApplication/خدمات-اپلیکیشن-موبایل-1024x576.jpg"} alt="img" className='w-full'/>
        <div className='flex flex-col gap-10 px-1'>
            <div className='flex flex-col-reverse sm:flex-row items-center'>
                ...
                <motion.img src={"/img/MobileApplication/5-min-1024x682.png"} alt="application or softwar" className='w-[15rem] sm:w-[25rem] sm:h-[15rem] h-[10rem]' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5,delay:0.5}} viewport={{once:true}}/>
            </div>
            <div>
            ...
            <div className='flex flex-col-reverse sm:flex-row gap-5 items-center justify-around'>
                ...
                <motion.img src={"/img/MobileApplication/6-min-1024x759.png"} alt="benifits-exclusive-application" className='w-[15rem] sm:w-[25rem] sm:h-[15rem] h-[10rem]' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div>
            ...
            <div className='flex flex-col-reverse sm:flex-row justify-around items-center'>
                ...
                <motion.img whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}} src={"/img/MobileApplication/3-min.png"} alt="img" className='w-[15rem] 2xl:w-[25rem]'/>
            </div>
            <div className='flex flex-col-reverse sm:flex-row justify-around items-center'>
                ...
                <motion.img whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}  src={"/img/MobileApplication/1-400x400.png"} alt="android-application" className='w-[20rem] 2xl:w-[25rem]'/>
            </div>
            <div className='flex flex-col-reverse sm:flex-row items-center justify-around'>
                ...
                <motion.img src={"/img/MobileApplication/2-min-400x400.png"} alt="java-application" className='w-[15rem] 2xl:w-[25rem]' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-col-reverse sm:flex-row items-center justify-around'>
                <div className='w-full sm:w-2/4'>
                ...
                <motion.img whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}} src={"/img/MobileApplication/4-min-300x300.png"} alt="ios-appliacation" className='w-[15rem] 2xl:w-[20rem]'/>
            </div>
            <motion.div whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}} className='gap-5 sm:gap-2 2xl:mt-10'>
                ...
                <div className='flex flex-col sm:flex-row gap-5 design-mobile-application'>
                    <div className='flex flex-col gap-3 2xl:gap-8 items-center'>
                        <img src={"/img/MobileApplication/android (2).png"} alt="andriod" className='w-[3rem] 2xl:w-[5rem]'/>
                    ...
                    <div className='flex flex-col gap-3 2xl:gap-8 items-center'>
                        <img src={"/img/MobileApplication/apple.png"} alt="apple"className='w-[3rem] 2xl:w-[5rem]'/>
                    ...
                    <div className='flex flex-col gap-3 2xl:gap-8 items-center'>
                        <img src={"/img/MobileApplication/java.png"} alt="java" className='w-[3rem] 2xl:w-[5rem]'/>
            ...
            <div className='flex flex-col gap-5 2xl:gap-10 2xl:mt-20'>
                ...
                <div className='flex flex-col gap-5 sm:gap-0 sm:flex-row justify-evenly items-center'>
                    <img src={"/img/MobileApplication/تعرفه-اپلیکیشن-موبایل-اقتصادی-min.png"} alt="tarrif" className='w-[15rem] sm:w-[25%] 2xl:w-[25rem] md:w-[28%]'/>
                    <img src={"/img/MobileApplication/تعرفه-اپلیکیشن-موبایل-حرفه-ای-min.png"} alt="tarrif" className='w-[15rem] sm:w-[25%] 2xl:w-[25rem] md:w-[28%]'/>
                    <img src={"/img/MobileApplication/تعرفه-اپلیکیشن-موبایل-ویژه-min.png"} alt="tarrif" className='w-[15rem] sm:w-[25%] 2xl:w-[25rem] md:w-[28%]'/>
        ...
        <div className='flex flex-col w-full sm:my-[3rem] m-0'>
            <EndBox1 content={{link:"/order",p:'جهت سفارش انواع پروژه  اپلیکیشن موبایل ، میتوانید به صورت رایگان ، با شماره 09927674217 تماس بگیرید و یا از طریق لینک زیر اقدام کنید.',b:'سفارش پروژه اپلیکیشن موبایل'}}/>
            <EndBox2  content={{link:"/workSamples/9/نمونه کار اپلیکیشن موبایل",p:'جهت مشاهده نمونه کارهای  اپلیکیشن موبایل  توسط تیم نهال آی تی از طریق لینک زیر اقدام کنید',b:'مشاهده نمونه کار اپلیکیشن موبایل'}}/>
        </div>
      <div>
        <FixedIcon />
      </div>
