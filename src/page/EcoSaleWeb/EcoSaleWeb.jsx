...
فرض کنید که شما در سایت‌تان یک بخشی دارید که میخواهید آخرین اخبار شرکت خودتان را نمایش دهید. برای نمایش این اخبار، از ۲ روش میتوانید استفاده کنید:</p>
        ...
        <div className='flex flex-col w-full'>
          <EndBox1 content={{link:'/workSamples/8/نمونه کار قالب آماده',p:' جهت مشاهده ی تمامی قالب های آماده به فروش (وردپرس (WordPress) و HTML و CSS و قالب جنگو (DJango)) و ثبت سفارش ، می توانید از طریق لینک زیر اقدام کنید.',b:'مشاهده انواع قالب ها و ثبت سفارش'}}/>
          <EndBox2 content={{link:'/workSamples/8/نمونه کار قالب آماده',p:'برای مشاهده و سفارش قالب ها و سایت های آماده ی طراحی شده توسط تیم نهال آی تی از طریق لینک زیر اقدام کنید',b:'مشاهده وب سایت و قالب های آماده '}}/>
        </div>
    </div>
      <div>
        <FixedIcon />
